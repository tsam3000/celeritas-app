...
import (
	...
	"github.com/tsam3000/celeritas/cache"
	"github.com/tsam3000/celeritas/mailer"
	"github.com/tsam3000/celeritas/render"
	"github.com/tsam3000/celeritas/session"
)
...
func (c *Celeritas) New(rootPath string) error {
	...
	// read .env - use godotenv package from github https://github.com/joho/godotenv
	...
	if c.Debug {
		var views = jet.NewSet(jet.NewOSFileSystemLoader(fmt.Sprintf("%s/views", rootPath)),
...
func (c *Celeritas) BuildDSN() string {
	...
	case "postgres", "postgresql":
		dsn = fmt.Sprintf("host=%s port=%s user=%s dbname=%s sslmode=%s timezone=UTC connect_timeout=5", os.Getenv("DATABASE_HOST"),
		os.Getenv("DATABASE_PORT"), os.Getenv("DATABASE_USER"), os.Getenv("DATABASE_NAME"), os.Getenv("DATABASE_SSL_MODE"))
